...
|---|---|---:|---:|---:|---:|---|
| Uiseong 2025-03 | EMIT 285b | 25,804 | 319,923 | **0.7467** | 2.30× | ≈ 0 |
| Sancheong 2025-03 | EMIT 285b | 252 | 9,945 | **0.6471** | 1.75× | 6.9e-16 |
| Gangneung 2023-04 | S2 13b (fallback) | 13,944 | 2,483,500 | **0.5487** | 1.97× | small |
| Uljin 2022-03 | S2 13b (fallback) | 495,890 | 3,291,745 | **0.5446** | 0.75× | small |
...
|---|---:|---|---:|
| Uiseong | 5.29 | 1.2 × 10⁻⁷ | **12.04** |
| Sancheong | 20.92 | ≈ 0 | **38.44** |
...
| Layer | Files | Size |
|---|---:|---:|
| EMIT L2A reflectance (Uiseong+Sancheong baselines + KR peninsula expansion) | 18 | 18.8 GB |
...
4. **Korean Forest Service 1:5,000 forest stand map is the unsung hero**: 161K
