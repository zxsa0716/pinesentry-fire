...
<strong>Submission state</strong>: final state<br/>
...
of (i) species pyrophilic factor from Korean Forest Service 1:5,000 forest stand map
...
<li><strong>Korean Forest Service 1:5,000 forest stand map</strong> — 3.41 M polygons converted
...
<ol>
<li>Uljin matsutake forest — predicted HSI 0.721 (Tricholoma matsutake pine forests)</li>
<li>Gwangneung autumn autumn senescence — predicted HSI 0.681 (autumn senescence transition)</li>
<li>Uiseong general forest — predicted HSI 0.672 (re-image 2025-03 fire scar)</li>
<li>Halla broadleaf forest — predicted HSI 0.485</li>
<li>Halla coniferous forest — predicted HSI 0.382</li>
<li>Gwangneung KoFlux GDK super-site — predicted HSI 0.367</li>
<li>Sancheong Cheonwangbong peak coniferous forest — predicted HSI 0.348</li>
</ol>
