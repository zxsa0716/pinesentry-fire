...
<strong>Submission state</strong>: v1.7 LOCKED 2026-04-30 (D-123)<br/>
...
<tr><td>v2.7</td><td>DiffPROSAIL gradient (scipy L-BFGS-B)</td><td><strong>0.500</strong> (no signal)</td></tr>
</table>
<div class="negative">
...
<ol>
<li>OSF DOI registration (30 min) — replace placeholder in CITATION.cff</li>
