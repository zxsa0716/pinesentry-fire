...
of (i) species pyrophilic factor from Korean Forest Service 1:5,000 forest stand map (임상도)
...
<li><strong>Korean Forest Service 1:5,000 forest stand map (임상도)</strong> — 3.41 M polygons converted
